...
export default function Lookbook() {
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden" id="lookbook">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-blush-200/10 blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                ...
                <div className="glass-card rounded-2xl overflow-hidden relative group animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                  ...
                  <div className="absolute inset-0 bg-black/20 flex items-center justify-center group-hover:bg-black/30 transition-colors">
                    <button className="w-14 h-14 rounded-full bg-white/80 backdrop-blur-sm flex items-center justify-center hover:bg-white transition-all shadow-lg group-hover:scale-110">
                      <Play size={20} className="text-blush-400 ml-0.5" fill="currentColor" />
                    </button>
                  </div>
                </div>
              </div>
            </div>
            <div className="absolute -top-4 -right-4 w-20 h-20 rounded-full bg-lavender-200/30 blur-xl animate-glow-pulse" />
            <div className="absolute -bottom-4 -left-4 w-16 h-16 rounded-full bg-peach-200/30 blur-xl animate-glow-pulse" style={{ animationDelay: '1s' }} />
          </div>
          ...
          <div className="lg:pl-8">
            ...
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-semibold text-charcoal mb-6 leading-tight">
              We Find. <span className="text-gradient">You Shop.</span>
            </h2>
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-8 font-body">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div key={item} className="flex items-center gap-3">
                  ...
                  <span className="text-gray-500 text-sm font-body">{item}</span>
                </div>
              ))}
            </div>
