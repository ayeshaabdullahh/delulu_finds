        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.instagram.com/thedeluludrip/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 hover:bg-mauve/20 flex items-center justify-center transition-colors border border-mauve/20" aria-label="Instagram">
